...
import { submitLabs } from "./actions";

export default function LabsForm() {
  const [state, formAction, isPending] = useActionState(submitLabs, null);
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <div>
        ...
        />
        {state?.fieldErrors?.sbp ? (
          <p className="mt-1 text-xs text-red-600 dark:text-red-400">{state.fieldErrors.sbp}</p>
        ) : (
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
        />
        {state?.fieldErrors?.ldl ? (
          <p className="mt-1 text-xs text-red-600 dark:text-red-400">{state.fieldErrors.ldl}</p>
        ) : (
          <p className="mt-1 text-xs text-slate-500 dark:text-zinc-500">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
        />
        {state?.fieldErrors?.hdl ? (
          <p className="mt-1 text-xs text-red-600 dark:text-red-400">{state.fieldErrors.hdl}</p>
        ) : (
          <p className="mt-1 text-xs text-slate-500 dark:text-zinc-500">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
        />
        {state?.fieldErrors?.glucose ? (
          <p className="mt-1 text-xs text-red-600 dark:text-red-400">{state.fieldErrors.glucose}</p>
        ) : (
          <p className="mt-1 text-xs text-slate-500 dark:text-zinc-500">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
        />
        {state?.fieldErrors?.triglycerides ? (
          <p className="mt-1 text-xs text-red-600 dark:text-red-400">{state.fieldErrors.triglycerides}</p>
        ) : (
          <p className="mt-1 text-xs text-slate-500 dark:text-zinc-500">
